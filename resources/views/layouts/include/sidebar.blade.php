<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ route('home') }}" class="brand-link">
      <img src="{{asset('fontend/imgs/logo_BookingTravel_2.png')}} " alt="Admin Logo" class="brand-image elevation-3" >
      <span class="brand-text font-weight-light">Admin - BookingTravel</span>
    </a>
